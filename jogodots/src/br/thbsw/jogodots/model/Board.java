package br.thbsw.jogodots.model;
...
public class Board {
    ...
    public boolean markDash(int row, int column, int player, char dash) {
        ...
        // Closed squares at bottom right boarder
        ...
        // Closed inner boarder squares
            ...
            if (dash == 'H') {
                // Closed upper and bottom squares
    ...
    public boolean isClosed(int row, int column, char dash) {
        ...
        if (((row == 0) && (dash == 'H')) || ((column == 0) && (dash == 'V'))) {
            ...
            if (dash == 'V') {
                return (verticalLines[row][column + 1]) && (horizontalLines[row][column]) && (horizontalLines[row + 1][column]);
            }
        }
        ...
        // Closed squares at bottom right boarder
            ...
            if (dash == 'V') {
                return (verticalLines[row][column - 1]) && (horizontalLines[row][column - 1]) && (horizontalLines[row + 1][column - 1]);
            }
